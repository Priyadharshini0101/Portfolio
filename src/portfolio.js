...
const greeting = {
  ...
  title: "Hello, I'm Priyadharshini",
  subTitle: emoji(
    "A passionate Software Developer 🚀 with experience in building user friendly and efficient applications. I enjoy solving problems, learning new technologies, and contributing to impactful projects."
  ),
  resumeLink:
    "https://drive.google.com/file/d/1TvkXkIVDLk9I8hoobYKPIvahTV34pcWq/view?usp=sharing", // Set to empty to hide the button
...
const bigProjects = {
  ...
  projects: [
    {
      image: require("./assets/stack/UFarm.png"),
